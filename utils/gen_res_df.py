...
NUM_EVAL_EPISODES = 5000 # Number of episodes to evaluate on
DETERMINISTIC = True 
SELECT_FROM = 5000 # Number of test scenes
...
test_eval_files = sorted([os.path.basename(file) for file in test_file_paths])[:NUM_EVAL_EPISODES]
...
if __name__ == '__main__':  
    ...
    for model_config in models_config.trade_off_analysis:
    ...
    df_all.to_csv(f'evaluation/results/df_trade_off_0131.csv', index=False)